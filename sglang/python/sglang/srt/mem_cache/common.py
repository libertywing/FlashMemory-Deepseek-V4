...
def evict_from_tree_cache(tree_cache: BasePrefixCache | None, num_tokens: int):
    ...
    if isinstance(allocator, (SWATokenToKVPoolAllocator, HiSparseTokenToKVPoolAllocator)):
        # Hybrid allocator
...
def available_and_evictable_str(tree_cache) -> str:
    ...
    from sglang.srt.mem_cache.hisparse_memory_pool import HiSparseTokenToKVPoolAllocator
    if isinstance(token_to_kv_pool_allocator, (SWATokenToKVPoolAllocator, HiSparseTokenToKVPoolAllocator)):
