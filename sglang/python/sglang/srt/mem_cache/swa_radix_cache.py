...
class SWARadixCache(BasePrefixCache):
    def __init__(self, params: CacheInitParams):
        # Allow HiSparseTokenToKVPoolAllocator which wraps SWATokenToKVPoolAllocator
        from sglang.srt.mem_cache.hisparse_memory_pool import HiSparseTokenToKVPoolAllocator
        assert isinstance(params.token_to_kv_pool_allocator, (SWATokenToKVPoolAllocator, HiSparseTokenToKVPoolAllocator))
    ...
    def evictable_size(self) -> Tuple[int, int]:
        return self.full_evictable_size_, self.swa_evictable_size_
